...
<div class="chat-list">
	<ul>
		<li class="chat-item user-2">
			<span class="user--chat-img sm"><img src="{{ 'donny.jpg' | prepend: site.assets.img | prepend: site.baseurl | prepend: site.url }}" class="img-responsive img-circle"></span>
